...
# more intricate for an A2, this probaby slows the process down 
llm = LLM(
    model=model_path,
...
messages = [
    ...
    {"role": "user", "content": [
        {"type": "image", "image": ""},
        {"type": "text", "text": "Detect and recognize text in the image, and output the word-level text coordinates in a formatted manner."}
    ]}
]
...
# TODO: this needs to be made parameter based from the command line
